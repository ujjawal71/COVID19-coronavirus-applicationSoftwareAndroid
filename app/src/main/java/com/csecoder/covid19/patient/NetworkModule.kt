...
import com.csecoder.covid19.data.network.NetworkConstants
import com.csecoder.covid19.data.network.category.CoronaS1Api
...
import com.csecoder.covid19.data.network.category.otherApi
...
fun provideDummyService(retrofit: Retrofit): otherApi =
    retrofit.create(otherApi::class.java)
